...
\section{Experience}
\cventry{15/09/2014 -- current}{Linux/Android R\&D for Intel Audio CoE}{Intel via Celad}
{Toulouse}{France}
{
    \begin{itemize}
...
\cventry{03/04/2014 -- 29/08/2014}{Internship: software developer focused on middleware/opensourcing}{Intel via Celad}
{Toulouse}{France}
{
    \begin{itemize}
